...
# The general stage sources the rest of 02-helpers/ INSIDE its own progress
# block, but the bar must be configured before that block opens. Source the
# progress helper early (it defines only functions and depends on nothing
# beyond 01-constants.R + namespace-qualified progressr/cli/checkmate) so
# pipeline_progress_handlers() exists when with_progress() runs.
