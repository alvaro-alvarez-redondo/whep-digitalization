# script: post-processing rule engine — footnote rules
# description: apply_footnote_rules, the semicolon-split / rule-match /
# reconstruct engine for footnote-sourced rules. Split from
# 23-payload-application.R (>500-line policy); pure definition, sourced with
